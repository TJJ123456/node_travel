<template>
  <div class="fillcontain">
    ...
    <div class="table_container">
      ...
      <el-dialog title="修改娱乐信息" :visible.sync="dialogFormVisible">
        <el-form :rules="dialogFormrules" :model="dialogForm" ref="dialogForm">
          ...
          <el-form-item label="娱乐分类" prop="type">
            <el-select v-model="dialogForm.type" placeholder="请选择娱乐分类">
              <el-option
...
export default {
  ...
  methods: {
    ...
    async GetListCount() {
      let data = await this.$fetch("entertainment/count");
    ...
    async getList() {
      let data = await this.$fetch("entertainment/list", {
        method: "POST",
        body: JSON.stringify({
          limit: this.limit,
          offset: this.offset
    ...
    async handleDelete(index, row) {
      let data = await this.$fetch("entertainment/delete", {
        method: "POST",
        body: JSON.stringify({
    ...
    async changeFood() {
      let data = await this.$fetch("entertainment/change", {
        method: "POST",
